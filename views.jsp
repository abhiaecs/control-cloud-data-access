...
ResultSet r=st.executeQuery("select *from filestore where fid='"+request.getParameter("fid")+"'  ");
if(r.next()){%>
<center><h1>ViewFile</h1>

<table align="center"><tr>
	<td><h3>FileName :</h3></td>
	<td><input type="text" name="nm" value=<%=r.getString("fname")%> readonly></td>
</tr>
<tr><td><h3>FileData:</h3></td>
	<td><textarea name="" rows="8" cols="25" readonly><%=r.getString("filedata")%></textarea></td>
</tr>
