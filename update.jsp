...
String rvk=atrbt+"RVK";
int r=st.executeUpdate("update uregister set loc='"+rvk+"' where no='"+fileid+"' ");
if(r!=0){
	st.executeUpdate("delete from ct");
response.sendRedirect("req.jsp?m=success");
}}catch(Exception e){
e.printStackTrace();}%>
