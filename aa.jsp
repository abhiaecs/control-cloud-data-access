...
<% if(request.getParameter("reg")!=null){
     ...
     <center>   <h2>Attribute Authority Login</h2><br>
<form action="aaCheck.jsp">
<table><tr>
...
<tr><td></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Login"></td></tr><tr> <td><a href="aaregister.jsp"><img src="images/reg1.png" width="108" height="70" border="0" alt="New User"></a></td></tr>
</table>
</form>
