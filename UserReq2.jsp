...
<% if(request.getParameter("msg")!=null){
	  out.println("<script>alert('Request is Approved by DSC')</script>");
}%>
<%
try{
...
<%
ResultSet r=st.executeQuery("select *from dsc");
while(r.next()){%>
...
<td><a href="DSCAproved.jsp?id=<%=r.getInt(1)%>">Approved</a> &nbsp;/&nbsp;<a href="DSCNotAproved.jsp?id=<%=r.getInt(1)%>">NotApproved</a></td></tr>
<%}%>
