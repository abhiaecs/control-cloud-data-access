...
<tr>
	...
	<td><input type="text" name="unm" value=<%=r.getString("unm")%> readonly></td>
</tr>

<tr>
	<td><h3>Email :</h3></td>
	<td><input type="text" name="email" value=<%=r.getString("email")%>>
	</td>
</tr>
<tr>
	<td><h3>Mobile No :</h3></td>
	<td><input type="text"  name="mno" value=<%=r.getString("mno")%>></td>
</tr>
<tr>
	<td><h3>Location :</h3></td>
	<td><input type="text"  name="loc" value=<%=r.getString("loc")%>></td>
</tr>

<tr>
	<td><h3>Experience:</h3></td>
	<td><input type="text"  name="exp" value=<%=r.getString("exp")%>></td>
</tr>
<tr>
	<td><h3>Specility:</h3></td>
	<td><input type="text"  name="splty" value=<%=r.getString("splty")%>></td>
</tr>

<tr>
	<td><h3>MedicalDegree:</h3></td>
	<td><input type="text"  name="mdg" value=<%=r.getString("mdegree")%>></td>
</tr>
