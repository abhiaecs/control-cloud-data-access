...
<% if(request.getParameter("update")!=null){
	 ...
	 <% if(request.getParameter("atrbt")!=null){
	  out.println("<script>alert('Keys are not Created by Attribute Authorities')</script>");
}%>
...
<tr><td></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Login"></td></tr><tr> <td><a href="register.jsp"><img src="images/reg1.png" width="108" height="70" border="0" alt="New User"></a></td></tr>
</table>
</form>
