...
%>
<table border=2><tr><th>NO.</th><th>Name</th><th>Email</th><th>Approved</th></tr>
<%
...
<td><a href="CAAproved.jsp?id=<%=r.getInt(1)%>"><font size="" color="#3366ff">Approved</font></a><!-- <a href="KGCNotAproved.jsp?id=<%=r.getInt(1)%>">NotApproved</a> --></td></tr>
<%}%>
