...
<% if(request.getParameter("reg")!=null){
     ...
     <center>   <h2>Owner Login</h2><br>
<form action="oCheck.jsp">
<table><tr>
...
<tr><td></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Login"></td></tr><!-- <tr> <td><a href="oregister.jsp"><img src="images/reg1.png" width="108" height="70" border="0" alt="New User"></a></td></tr> -->
</table>
</form>
